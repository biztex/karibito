...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('job_request_chatroom_messages', function (Blueprint $table) {
            $table->id();
            $table->foreignId('job_request_chatroom_id')->constrained()->cascadeOnDelete()->comment('サービスやり取りID');
    ...
    {
        Schema::dropIfExists('job_request_chatroom_messages');
    }
};
