...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'prefecture_id' => [
            'required_if' => '対面・どちらでもの場合、エリアも指定してください。',
        ...
        'application_deadline' => [
            'after' => '応募期限には、本日以降の日付を指定してください。',
        ],
        'required_date' => [
            'after' => '納期希望日には、本日以降の日付を指定してください。',
        ],
        'user_use_point' => [
            'required_if' => 'ポイントを利用する場合、利用するポイントを入力してください。',
            'max' => '上限を超えるポイントを利用することはできません。',
            'lte' => '利用できるポイントは合計金額の10%までです。'
        ]
