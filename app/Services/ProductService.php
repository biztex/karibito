...
class ProductService
{
    ...
    {
        // $columns = ['category_id', 'prefecture_id', 'title', 'content', 'price', 'is_online', 'number_of_day', 'time_unit', 'is_call', 'number_of_sale', 'status'];仕様によって電話対応を一旦非表示
        $columns = ['category_id', 'prefecture_id', 'title', 'content', 'price', 'is_online', 'number_of_day', 'time_unit', 'number_of_sale', 'status'];
    ...
    {
        // $columns = ['category_id', 'prefecture_id', 'title', 'content', 'price', 'is_online', 'number_of_day', 'time_unit', 'is_call', 'number_of_sale', 'status'];　電話対応は仕様変更によって一旦非表示
        $columns = ['category_id', 'prefecture_id', 'title', 'content', 'price', 'is_online', 'number_of_day', 'time_unit', 'number_of_sale', 'status'];
