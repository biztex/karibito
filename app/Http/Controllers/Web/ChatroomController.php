...
class ChatroomController extends Controller
{
    ...
    {
        $seller_chatrooms = Chatroom::sellerChatroom()->latest()->paginate(10);
        $step = 'all';
    ...
    {
        $seller_chatrooms = Chatroom::sellerProposalChatroom()->latest()->paginate(10);
        $step = 'proposal';
    ...
    {
        $seller_chatrooms = Chatroom::sellerCompleteChatroom()->latest()->paginate(10);
        $step = 'complete';
    ...
    {
        $seller_chatrooms = Chatroom::sellerWorkChatroom()->latest()->paginate(10);
        $step = 'work';
    ...
    {
        $seller_chatrooms = Chatroom::sellerCancelChatroom()->latest()->paginate(10);
        $step = 'cancel';
    ...
    {
        $seller_chatrooms = Chatroom::sellerTrashChatroom()->latest()->paginate(10);
        $step = 'trash';
    ...
    {
        $buyer_chatrooms = Chatroom::buyerChatroom()->latest()->paginate(10);
        $step = 'all';
    ...
    {
        $buyer_chatrooms = Chatroom::buyerProposalChatroom()->latest()->paginate(10);
        $step = 'proposal';
    ...
    {
        $buyer_chatrooms = Chatroom::buyerCompleteChatroom()->latest()->paginate(10);
        $step = 'complete';
    ...
    {
        $buyer_chatrooms = Chatroom::buyerWorkChatroom()->latest()->paginate(10);
        $step = 'work';
    ...
    {
        $buyer_chatrooms = Chatroom::buyerCancelChatroom()->latest()->paginate(10);
        $step = 'cancel';
    ...
    {
        $buyer_chatrooms = Chatroom::buyerTrashChatroom()->latest()->paginate(10);
        $step = 'trash';
