			...
			<div class="cancelWrap">
				<div class="inner inner05">
                    ...
                    <div class="cancelRea mt20">
                        <p>
                            「承認する」を選択した場合、キャンセル成立となります。引き続きお相手の方の評価を入力してください。双方の評価入力が完了した時点でキャンセル完了となり、決済方法に応じてサービス手数料を含む代金が購入者の方に返金されます。<br />
                            「再交渉する」を選択した場合は、再度チャットにてすり合わせを行ってください。<br />
                            72時間以内に「承認する」も「再交渉する」も選択しなかった場合は自動的に「承認する」が選択され、評価入力へと進みます。
                        </p>
                    </div>
