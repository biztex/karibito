				...
				<div class="inner inner05">
					...
					@csrf
						...
						<div class="warnNotes mt50">
							<p class="danger">！キャンセルについて<br>キャンセルは原則として双方の合意が必要です。トラブル防止のため、必ず明確な理由をお伝えください。相手の方がキャンセル申請に「承認」も「再交渉」も選択しないまま72時間が経過した場合は、自動的に「承認」となります。その後、双方の評価入力をもってキャンセルは完了します。</p>
...
{{--							<p class="note">※キャンセル申請をするとマイページにキャンセル申請の数が表示されます</p>--}}
						...
						<div class="functeBtns">
							<input type="submit" formaction="{{ route('cancel.confirm', $purchase->id) }}" formmethod="post" class="blue loading-disabled" value="キャンセル手続きに進む">
