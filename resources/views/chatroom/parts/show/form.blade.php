    ...
    @csrf
        <div class="item">
            ...
            <div class="evaluation">
                <textarea id="templateText" name="text" placeholder="本文を入力してください" class="templateText" onclick="ClickShowLength(value);" oninput="ShowLength(value);">{{ old('text') }}</textarea>
...
なお、承認をいただきましたら速やかに評価をご入力いただけると幸いでございます。双方の評価入力が完了後、代金は支払方法に応じて後日返金されると存じております。よろしくお願い致します。
            </textarea>
        </div>
...
なお、承認を頂きましたら速やかに評価をご入力いただけると幸いでございます。
