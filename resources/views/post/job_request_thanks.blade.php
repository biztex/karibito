				...
				<div class="inner inner05">
					...
					<div class="shareSnsEmail">
						...
						<div class="sns">
							...
							<a href="https://twitter.com/share?url={{ session('url') }}&text=カリビトのリクエストをシェア&hashtags=karibito" target="_blank"><img src="img/mypage/ico_twitter.svg" alt=""></a>{{-- href="https://twitter.com/share?url={{URL}}&text={{本文}}&hashtags={{ハッシュタグ}}" --}}
							<a href="mailto:?subject=カリビトのリクエストをシェア&body=本文" target="_blank"><img src="img/mypage/ico_mail.svg" alt=""></a>
						</div>
						<form>
							<table>
								<tr>
