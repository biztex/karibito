				...
				<div id="main">
					<div class="secretWrap">
						...
						<div class="secretPager">
							<div class="secretPagerPrev"><a href="secret01.html">前へ</a></div>
							<select onchange="document.location.href=this.options[this.selectedIndex].value;">
								<option value="secret01.html">1/6</option>
								<option value="secret02.html" selected>2/6</option>
							...
							<div class="secretPagerNext"><a href="secret03.html">次へ</a></div>
						</div>
					</div>
				</div><!-- /#main -->
				<x-side-menu/>
