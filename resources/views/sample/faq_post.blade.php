...
<article>
		...
		<div id="contents" class="otherPage">
			<div class="inner02 clearfix">
				<div id="main">
					<div class="faqPostWrap">
						<h2 class="subPagesHd">質問投稿</h2>
						<p class="faqPostP01">カリビト知恵袋はみんなでつくる便利でうれしい知恵の共有サービス。<br>参加している方がお互いに知恵や知識をQ&Aで共有できるサイトです。</p>
						<div class="faqDtTop">
							<div class="faqDtCont">
								<p class="faqDtContHd">投稿する内容をご記入ください</p>
								<textarea class="faqDtContText" placeholder="5文字以上で入力してください"></textarea>
								<p class="faqDtContHd">カテゴリを選択してください</p>
								<div class="faqPostSelect">
									<select>
										<option disabled="" selected="">選択してください</option>
										<option>カテゴリを1</option>
										<option>カテゴリを2</option>
										<option>カテゴリを3</option>
									</select>
								</div>
								<div class="fancyPersonBtn">
									<a href="#" class="fancyPersonCancel">キャンセル</a>
									<input class="fancyPersonSign" type="submit" name="" value="送信する">
								</div>
							</div>
						</div>
					</div>
