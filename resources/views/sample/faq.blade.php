		...
		<div id="contents" class="otherPage">
			<div class="inner02 clearfix">
				<div id="main">
					<div class="faqWrap">
						<div class="faqSec01">
							<h2 class="subPagesHd">カリビト知恵袋</h2>
							<div class="faqTop">
								<div class="box">
									<p class="txt">カリビト知恵袋はみんなでつくる<br>便利でうれしい知恵の共有サービス。</p>
									<p class="img"><img src="/img/faq/img_top.png" alt=""></p>
								</div>
								<p class="btn"><a href="#">知恵袋に投稿する <img src="/img/faq/icon01.png" alt="みんなで解決!!"></a></p>
							</div>
							<p class="faqSearch"><input type="text" placeholder="Q&Aを探す" name=""></p>
							<div class="faqTab tabWrap">
								<ul class="tabLink">
									<li><a href="#tab_box01" class="is_active">回答受付中</a></li>
									<li><a href="#tab_box02" class="">解決済み</a></li>
								</ul>
								<div class="tabBox is_active" id="tab_box01">
									<select class="faqSelect">
										<option>カテゴリを選択してください</option>
										<option>カテゴリを選択してください2</option>
										<option>カテゴリを選択してください3</option>
									</select>
									<div class="faqBox">
										<ul class="faqUl01">
											<li>
												<p class="txt"><a href="faq_detail.html">電話相談を出品しました。が、提携形態が「電話」しか表示されず、電話しか選べません。通話料がかかりますよ…</a></p>
												<div class="line">
													<p class="date">2021年7月26日　13:43</p>
													<p class="comment"><a href="faq_detail.html">12</a></p>
												</div>
											</li>
											<li>
												<p class="txt"><a href="faq_detail.html">電話相談を出品しました。が、提携形態が「電話」しか表示されず、電話しか選べません。通話料がかかりますよ…</a></p>
						...
						<div class="faqSec02">
							<h2 class="subPagesHd">過去に投稿した知恵袋</h2>
							<div class="faqBox">
								<ul class="faqUl01">
									<li>
										<p class="txt"><a href="faq_detail.html">電話相談を出品しました。が、提携形態が「電話」しか表示されず、電話しか選べません。通話料がかかりますよ…</a></p>
						...
						<div class="faqSec02">
							<h2 class="subPagesHd">回答済み知恵袋</h2>
							<div class="faqBox">
								<ul class="faqUl01">
									<li>
										<p class="txt"><a href="faq_detail.html">電話相談を出品しました。が、提携形態が「電話」しか表示されず、電話しか選べません。通話料がかかりますよ…</a></p>
