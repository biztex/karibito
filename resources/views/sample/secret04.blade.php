				...
				<div id="main">
					<div class="secretWrap">
						...
						<div class="secretPager">
							<div class="secretPagerPrev"><a href="secret03.html">前へ</a></div>
							<select onchange="document.location.href=this.options[this.selectedIndex].value;">
								...
								<option value="secret04.html" selected>4/6</option>
								<option value="secret05.html">5/6</option>
								<option value="secret06.html">6/6</option>
							</select>
							<div class="secretPagerNext"><a href="secret05.html">次へ</a></div>
						</div>
					</div>
				</div><!-- /#main -->
