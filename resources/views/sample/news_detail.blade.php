			...
			<div class="inner02 clearfix">
				<div id="main">
					<div class="subPagesWrap">
						<h2 class="subPagesHd">事務局から個別メッセージ「ログイン通知」</h2>
						<div class="newsDtWrap">
							<p class="date">2021年7月26日</p>
							<div class="cont">
								<p>いつもご利用いただきありがとうございます。</p>
								<p>こちらは、お客さまのアカウントを使ってカリビトへログインしたことを通知するメッセージです。</p>
								<p>■詳細情報<br>ログイン日時: 2021/12/16 13:42<br>利用: [Webサイト]</p>
								<p>お客さま自身がメルカリにログインを行った場合は問題ありません。<br>心当たりがない場合は、詳細を記載したメールをこの通知と同時にご登録いただいているメールアドレスにお送りさせていただいておりますので、メールをご確認ください。</p>
							</div>
						</div>
					</div>
				</div><!-- /#main -->
				<aside id="side" class="pc">
					...
					<div class="sideItem">
						<ul class="sideUl01">
							...
							<li><a href="#" class="is_active">プロモーション・お知らせ</a></li>
