				...
				<div id="main">
					<div class="secretWrap">
						...
						<div class="secretPager">
							<div class="secretPagerPrev"><a href="secret04.html">前へ</a></div>
							<select onchange="document.location.href=this.options[this.selectedIndex].value;">
								...
								<option value="secret05.html" selected>5/6</option>
								<option value="secret06.html">6/6</option>
							</select>
							<div class="secretPagerNext"><a href="secret06.html">次へ</a></div>
						</div>
					</div>
				</div><!-- /#main -->
				<x-side-menu/>
