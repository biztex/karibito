...
<article>
		<div id="breadcrumb">
			<div class="inner">
				<a href="index.html">ホーム</a>　>　<span>カテゴリー追加依頼</span>
			</div>
		</div><!-- /.breadcrumb -->
			...
			<div class="inner">
				<div id="main">
					<div class="subPagesWrap">
						<h2 class="subPagesHd">カテゴリー追加依頼</h2>
						<div class="contactBox">
							<form action="#" method="post">
								...
								<div class="labelCategory">
									<p>大カテゴリー</p>
									<p><input type="text" name="category01" placeholder="入力してください"></p>
								</div>
								<div class="labelCategory">
									<p>小カテゴリー</p>
									<p><input type="text" name="category02" placeholder="入力してください"></p>
								</div>
								<p class="formBtn"><input type="submit" class="submit" value="送信する"></p>
							</form>
							<div class="contactBottom">
								<p>メールアドレスが間違っていたり、ドメイン指定受信をしていると返答が届きませんのでご注意ください。</p>
								<p class="textLink"><a href="#">カリビトのドメイン指定方法</a></p>
							</div>
						</div>
					</div>
				</div><!-- /#main -->
