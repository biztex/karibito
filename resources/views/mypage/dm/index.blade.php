									...
									<a href="{{ route('dm.show', $dmroom_user->id) }}">
										<div class="user">
											@if($dmroom_user->from_user_id === Auth::id())
												...
												@else
													<p class="ico"><img src="{{ asset('/storage/'.$dmroom_user->toUser->userProfile->icon) }}" alt=""></p>
												@endif
												<div class="introd">
											...
											@else
												@if($dmroom_user->fromUser->userProfile->icon === null)
													<p class="ico"><img src="/img/mypage/no_image.jpg" alt=""></p>
												@else
													<p class="ico"><img src="{{ asset('/storage/'.$dmroom_user->fromUser->userProfile->icon) }}" alt=""></p>
												@endif
												<div class="introd">
