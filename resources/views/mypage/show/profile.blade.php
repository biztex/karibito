<div class="mypageSec01">
    ...
    <dl class="mypageDl01">
        ...
        @endif
        <dd>
            <div class="mypageP01">{{Auth::user()->userProfile->user->name}} <a href="#fancybox_person" class="fancybox fancybox_profile"><img src="/img/mypage/btn_person.svg" alt="プロフィールを編集"></a></div>
