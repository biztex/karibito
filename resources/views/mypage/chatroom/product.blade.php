        ...
        <div class="cont01">
            ...
            <div class="info">
                <div class="breadcrumb">
                    <a href="{{ route('product.category.index',$value->referencePurchased->mProductChildCategory->mProductCategory->id) }}">
                        {{ $value->referencePurchased->mProductChildCategory->mProductCategory->name}}</a>&emsp;＞&emsp;
                    <a href="{{ route('product.category.index.show',$value->referencePurchased->mProductChildCategory->id)}}">
                ...
                <div class="single">
                    <a tabindex="0">{{App\Models\Product::IS_ONLINE[$value->referencePurchased->is_online]}}</a>
                </div>
            </div>
...
@else
    <li>
        <div class="cont01">
            ...
            <div class="info">
                <div class="breadcrumb">
                    <a href="{{ route('product.category.index',$value->reference->mProductChildCategory->mProductCategory->id) }}">
                        {{ $value->reference->mProductChildCategory->mProductCategory->name}}</a>&emsp;＞&emsp;
                    <a href="{{ route('product.category.index.show',$value->reference->mProductChildCategory->id)}}">
