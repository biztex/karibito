		...
		<div id="contents">
			<div class="supportWrap supportDetail detailStyle">
				<div class="inner inner04">
					...
					<div class="title">
						<h2 class="hdM">カリビトでの禁止行為</h2>
						<p class="sub">購入者と出品者の双方が安心してカリビトをご利用いただくため、カリビトでは禁止行為のルールを定めています。<br>禁止行為が確認された場合は、運営にてサービスや相談・提案の取り消しを行い、場合によっては利用アカウントの停止も含めた措置を行っております。<br>購入者と出品者の双方に対し、より安心・安全なプラットフォームを提供するための対応となりますので、何卒ご理解いただければ幸いです。</p>
