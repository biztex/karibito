					...
					<div class="optional" id="support01">
                        ...
                        <ul class="toggleWrapPC">
                            ...
                            <li>
                                ...
                                <p class="answer toggleBox">プロフィールに表示することで「必要に応じて秘密保持契約を結びます」という意思を伝えるためのマークです。このマークを表示している方同士のチャット画面には「NDAを送付する」ボタンが表示され、フォーマットを活用して秘密保持契約（NDA)を締結していただけます。このマークを表示することで双方の信頼感が高まり、依頼の増加や受注率のアップ、スムーズな交渉が期待できます。＊【秘密保持契約（NDA)締結可】マークの表示には本人確認が必須です。</p>
                            </li>
                            <li>
