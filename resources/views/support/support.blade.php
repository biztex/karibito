					...
					<div class="optional" id="support01">
                        ...
                        <ul class="toggleWrapPC">
                            ...
                            <li>
                                ...
                                <p class="answer toggleBox">秘密保持契約とは、チャット等非公開のやりとりで知り得た秘密情報を、目的以外の用途で使用したり、第三者に漏えいしないことを定めた契約書です。双方の必要に応じて、チャット画面上の「NDA」のフォーマットをご活用ください。なお、秘密保持契約を結ぶためには本人確認が必須です。</p>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <p class="answer toggleBox">
                                    １.トップページまたはマイページの【お友達紹介】をタッチしてください。<br><br>
                                    ２.表示された【招待コード】【招待コードURL】をコピーして、お友達に送ってください。<br><br>
                                    ３.お友達が【招待コード】【招待コードURL】を使用して会員登録を行うと、認証完了後【300  円OFFクーポン】が付与されます。
                                </p>
                            </li>
                        </ul>
                        ...
                        <ul class="toggleWrapPC">
                            ...
                            <li>
                                ...
                                <p class="answer toggleBox">対面のサービスは原則として本人確認が必須となります。お互いのトラブル防止のため、必ず本人確認を行ってから出品をお願いします。未登録では出品できませんのでご注意ください。</p>
                            </li>
                            <li>
                                ...
                                <p class="answer toggleBox">
                                    ...
                                    <a href="{{route('guide')}}" class="supportLink" target="_blank">出品時のマナーはこちら</a><br>
                            ...
                            <li>
                                ...
                                <p class="answer toggleBox">
                                    チャットにて再度【評価入力】をお願いしてください。【納品完了】通知が承認されてから未評価のまま<span class="colorRed">72時間</span>が経過した場合は、自動的に【普通】が入力されますので、購入者の方の評価入力を行ってください。
                                </p>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <p class="answer toggleBox">
                                    取引完了後、売上金が計上されますので、マイページより振込申請を行ってください。振込申請期間は120日間となりますので、期日内に申請をお願いします。<span class="colorRed">期日を過ぎますと、自動的にご登録の銀行口座に売上金が振り込まれます。</span>銀行口座は【マイページ】＞【会員情報】よりご登録いただけます。
                                </p>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <p class="answer toggleBox">
                                    不正利用防止のため【出品者情報】の登録内容と【振込先銀行口座】の名義が一致していない場合は、売上金の振り込みが出来ません。ご注意ください。
                                </p>
                            </li>
                            <li>
                        ...
                        <ul class="toggleWrapPC">
                            <li>
                                ...
                                <p class="answer toggleBox">
                                    ...
                                    ２.チャットで出品者の方に購入の意思を伝えて【サービスの提供】通知を送ってもらいます。届いた通知から購入・決済手続きに進みましょう。<br><br>
                            ...
                            <li>
                                ...
                                <p class="answer toggleBox">
                                    ...
                                    <a href="{{route('guide')}}" class="supportLink" target="_blank">購入時のマナーはこちら</a>
                                </p>
                            </li>
                            <li>
                                <p class="quest toggleBtn"><span>メッセージのやり取り方法は？</span><span class="more">回答を見る</span></p>
                            ...
                            <li>
                                ...
                                <p class="answer toggleBox">
                                    再度メッセージを送信し、状況の確認をお願いします。出品者の方からの返信が<span class="colorRed">72時間</span>以上ない場合は、必ず理由を明記の上【キャンセル申請】を送ってください。<br><br>
                                    　【キャンセル申請】通知後<span class="colorRed">72時間</span>以内に出品者の方から返信がなければ、自動的に【キャンセル申請】は承認されます。<br><br>
                                    　詳しいキャンセルのやり方については、<a href="{{route('karibitoguide')}}" class="supportLink" target="_blank">カリビトガイド＞キャンセル申請を送る時のプロセス</a>をご確認ください。
                                </p>
                            </li>
                            <li>
                                ...
                                <p class="answer toggleBox">
                                    ...
                                    ＊【納品完了】通知が届いてから72時間以内に【承認】と【リトライ】のどちらも選択しなかった場合、自動的に【承認】となりますのでご注意ください。<br>
                            ...
                            <li>
                                ...
                                <p class="answer toggleBox">
                                    ...
                                    ＊【納品完了】通知に承認後、<span class="colorRed">72時間</span>以内に【評価入力】が行われない場合、自動的に【普通】が入力されます。
                                </p>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <p class="answer toggleBox">
                                    決済画面で【クーポンを利用する】にチェックを入れ、利用可能なクーポンを選択してください。1度の決済で利用できるクーポンは1枚のみとなります。決済終了後にクーポンを使用することは出来ませんのでご注意ください。
                                </p>
                            </li>
                            <li>
                                <p class="quest toggleBtn"><span>ポイントでの支払い方法は？</span><span class="more">回答を見る</span></p>
                                <p class="answer toggleBox">
                                    決済画面の【ポイント利用】の【利用する】にチェックを入れ、利用ポイント額を入力してください。（ポイント利用額の上限は、購入金額の１０％となります。）決済完了後にポイントを使用することはできませんのでご注意ください。
                                </p>
                            </li>
                            <li>
                        ...
                        <ul class="toggleWrapPC">
                            ...
                            <li>
                                ...
                                <p class="answer toggleBox">
                                    ...
                                    通知された【キャンセル申請】に返答がないまま<span class="colorRed">72時間</span>が経過した場合は、自動的に【承認する】が選択されます。
                                </p>
                            </li>
                            <li>
                                <p class="quest toggleBtn"><span>キャンセル時の評価入力は必須ですか？</span><span class="more">回答を見る</span></p>
                                <p class="answer toggleBox">キャンセルは双方の評価入力が完了した時点で成立となりますので、必ず行ってください。評価はキャンセルされた側、キャンセルした側の順で行います。双方とも、評価入力の通知が届いてから未評価のまま<span class="colorRed">72時間</span>が経過した場合は、自動的に「普通」が選択されます。</p>
                            </li>
                            <li>
