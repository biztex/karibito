				...
				<div class="inner inner03">
					...
					<ul>
						<li>
							...
							<p>カリビトを使うと、アプリを してご 所さん気 に会って、助け合うことができます。〇〇〇から〇〇〇まで、様々なジャンルで助け合いましょう。</p>
						</li>
						<li>
							<p class="tit"><span class="point">point2</span>サービスの提供</p>
							<div class="img"><img src="img/guide/img_app02.png" srcset="img/guide/img_app02.png 1x, img/guide/img_app02@2x.png 2x" alt="サービスの提供"></div>
							<p>自分の得意で誰かの役に立ちたい、気軽におこづかいを稼ぎたい、という人はサービスを提供しましょう。</p>
						</li>
						<li>
							...
							<p>自分の困りごとを誰かに解決してほしい、という人はリクエストを募集しましょう。</p>
						</li>
						<li>
							...
							<p>単発のリクエストと長期のリクエストの2種類のパターンがありますので、ライフスタイルや希望に合ったリクエストを見つけることが可能です。</p>
						</li>
						<li>
							...
							<p>カリビトでは、「リモート」でのお仕事と「対面」でのお仕事をそれぞれ募集や依頼することができます。インターネットが繋がればOKな仕事と店舗など対面で働く仕事を選択する事ができます。</p>
						</li>
					</ul>
				</div>
			</div>
