		...
		<div id="contents">
			<div class="inner inner03">
				<div class="guideTop">
					...
					<div class="btnTeams">
						<a href="/product/index/keyword/search?service_flg=1&keyword=&search_flg=1" class="blue">サービスを探す</a>
						{{-- @can('identify') --}}
			...
			<div class="guideApp">
				<div class="inner inner03">
					<h2><span class="hot">カリビトアプリ</span><br class="sp">で何ができる？</h2>
                    <h2>カリビトとは</h2>
					<ul>
						<li>
							<p class="tit"><span class="point">point1</span>街の助け合いアプリ</p>
							<div class="img"><img src="img/guide/img_app01.png" srcset="img/guide/img_app01.png 1x, img/guide/img_app01@2x.png 2x" alt="街の助け合いアプリ"></div>
							<p>カリビトは、日常におけるあらゆるスキルをシェアリング出来るプラットフォームです。人と人、街と人を繋ぐ架け橋となるアプリです。</p>
						</li>
						<li>
							<p class="tit"><span class="point">point2</span>スキルの出品</p>
							<div class="img"><img src="img/guide/img_app02.png" srcset="img/guide/img_app02.png 1x, img/guide/img_app02@2x.png 2x" alt="スキルの出品"></div>
							<p>自分の持つスキルやノウハウを収入に繋げたい、誰かの役に立てたいという方はスキルを出品しましょう。</p>
						</li>
						<li>
							<p class="tit"><span class="point">point3</span>リクエスト募集</p>
							<div class="img"><img src="img/guide/img_app03.png" srcset="img/guide/img_app03.png 1x, img/guide/img_app03@2x.png 2x" alt="リクエスト募集"></div>
							<p>探しているスキルが見つからない人は、スキルのリクエストが出来ます。あなたの困りごとを解決してくれる人を募集しましょう。</p>
						</li>
						<li>
							<p class="tit"><span class="point">point4</span>選べる期間</p>
							<div class="img"><img src="img/guide/img_app04.png" srcset="img/guide/img_app04.png 1x, img/guide/img_app04@2x.png 2x" alt="選べる期間"></div>
							<p>あなたのライフスタイルに合わせたスキルの出品が出来ます。短期・長期、無理のないスケジュールでスキルを提供しましょう。</p>
						</li>
						<li>
							<p class="tit"><span class="point">point5</span>選べる仕事体系</p>
							<div class="img"><img src="img/guide/img_app05.png" srcset="img/guide/img_app05.png 1x, img/guide/img_app05@2x.png 2x" alt="選べる仕事体系"></div>
							<p>カリビトでは、「対面」と「非対面」両方のスキルを出品・リクエスト出来ます。オンラインでできるお仕事と直接人と関わるお仕事、あなたのスキルに応じて選択できます。</p>
						</li>
					</ul>
				</div>
			</div>
					...
					<ul class="anchors">
						<li>
							<a href="#etiquette01" class="buy scroll">
								...
								<p class="tit">スキルを<span class="cate"><big>購入したい方へ</big><br class="sp"></span></p>
							</a>
						</li>
						<li>
							<a href="#etiquette02" class="provid scroll">
								<p class="ico"><img src="img/guide/ico_etiquette_point02.svg"></p>
								<p class="tit">スキルを<span class="cate"><big>出品したい方へ</big><br class="sp"></span></p>
							</a>
						</li>
					</ul>
				</div>
					...
					<div class="inner inner03">
						...
						<ul>
							<li>
                                ...
                                <p class="tit starFlex"><span>★</span><span>サービスの詳細をしっかりと確認し、疑問や不安点を無くしてから購入しましょう！</span></p>
							...
							<li>
                                ...
                                <p class="tit starFlex"><span>★</span><span>スピーディーな返信を心がけましょう！</span></p>
							...
							<li>
                                ...
                                <p class="status">【購入後】</p>
								<p class="tit starFlex"><span>★</span><span>要望やイメージは分かりやすく伝えましょう！</span></p>
                            ...
                            <li>
                                ...
                                <p class="status">【評価】</p>
                                <p class="tit starFlex"><span>★</span><span>納品完了後は速やかに評価の入力をしましょう！</span></p>
                                <p>カリビトのお取引は、双方の評価が入力された時点で完了となります。せっかく期日内に納品されても、あなたの評価が未入力であれば出品者の方は報酬が受け取れません。納品完了通知に承諾後は、すぐ評価入力を行いましょう。<br>また、あなたの評価は他の方が購入をされる際の判断材料の一つとなります。公正公平で丁寧な入力をしましょう。</p>
                            </li>
						</ul>
					</div>
				</div>
					...
					<div class="inner inner03">
						...
						<ul>
							<li>
                                ...
                                <p class="status">【交渉中】</p>
                                <p class="tit starFlex"><span>★</span><span>分かりやすい出品ページを作成しましょう！</span></p>
							...
							<li>
                                ...
                                <p class="status">【交渉中】</p>
                                <p class="tit starFlex"><span>★</span><span>購入者の方のお問い合わせには、迅速かつ丁寧に返信しましょう。</span></p>
							...
							<li>
                                ...
                                <p class="status">【契約後】</p>
                                <p class="tit starFlex"><span>★</span><span>納期をしっかりと守りましょう！</span></p>
							...
							<li>
                                ...
                                <p class="status">【契約後】</p>
                                <p class="tit starFlex"><span>★</span><span>「納品完了」通知は双方合意の上で送りましょう！</span></p>
                            ...
                            <li>
                                ...
                                <p class="status">【評価】</p>
                                <p class="tit starFlex"><span>★</span><span>忘れずに購入者の評価入力をしましょう！</span></p>
