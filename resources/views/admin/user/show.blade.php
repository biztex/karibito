<x-admin.app>
    ...
    <x-admin.flash_msg/>
        ...
        <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item d-flex"><p class="mb-0 mr-4"><span class="font-weight-bold">制限</span>：@if ($user->is_ban == App\Models\UserProfile::NOT_BAN) 制限なし @elseif ($user->is_ban == App\Models\UserProfile::IS_BAN) 制限中@endif</p></li>
