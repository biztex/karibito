                    ...
                    <div class="card-body p-5">
                        <form method="POST" action="{{ route('admin.categories.update', $category) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    @include('components.form.text', ['name' => 'name', 'required' => true, 'value' => $category->name ])
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <img src="{{ Illuminate\Support\Facades\Storage::url($category->banner_image_path) }}" width="200">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <img src="{{ Illuminate\Support\Facades\Storage::url($category->top_image_path) }}" width="200">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <img src="{{ Illuminate\Support\Facades\Storage::url($category->other_image_path) }}" width="200">
