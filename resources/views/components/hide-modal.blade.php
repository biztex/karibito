		...
		<!-- 身分証明証提出モーダル -------------------------------------------------------------- -->
			...
			<div style="display:flex;justify-content:space-between">
				...
				<div class="fancyboxCont">
					...
					<div class="fancyRegisterItem">
						<p class="txt">【カリビトアプリ登録情報】<br>都道府県:{{ $user_profile->prefecture->name }}<br>住所:{{ $user_profile->address }}<br>氏名:{{ $user_profile->first_name.$user_profile->last_name }}<br>生年月日:{{ $user_profile->birthday->format('Y年n月j日') }}</p>
					</div>
					<div class="fancyRegisterItem">
