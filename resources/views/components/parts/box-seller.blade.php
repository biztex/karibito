<div class="box seller">
    ...
    <p class="introd"><a href="{{ route('user.mypage', $user) }}" class="name">{{$user->name}}</a><br>({{App\Models\UserProfile::GENDER[$user->userProfile->gender]}} / {{$user->userProfile->birthday}}/ {{$user->userProfile->prefecture->name}})</p>
