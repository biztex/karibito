                            ...
                            @elseif($product->youtube_link)
                                @foreach($product->youtube_link as $num => $youtube_link)
                                    <div class="js-youtubeForm">
                                        ...
                                        <div class="td">
                                            <div class="enter">
                                                <input type="text" name="youtube_link[]" placeholder="YouTubeのリンクを入力してください" value="{{ old('youtube_link.'.$num, $youtube_link) }}">
                                            </div>
                                            <div>
                                                <a href="javascript:;" class="fs25 ml05 js-deleteYoutube">×</a>
                                            </div>
                                ...
                                @endforeach
                            @elseif(collect($product->productLink)->isNotEmpty())
                                @foreach($product->productLink as $num => $link)
                                    <div class="js-youtubeForm">
                                        <p class="th js-link">動画(YouTubeのみ) {{$num + 1}}</p>
                                        @error('youtube_link.'.$num)<div class="alert alert-danger">{{ $message }}</div>@enderror
                                        <div class="td">
                                            <div class="enter">
                                                <input type="text" name="youtube_link[]" placeholder="YouTubeのリンクを入力してください" value="{{ old('youtube_link.'.$num, $link->youtube_link) }}">
                                            </div>
                                            <div>
                                                <a href="javascript:;" class="fs25 ml05 js-deleteYoutube">×</a>
                                            </div>
                        ...
                        <p class="th">画像投稿<span class="must">必須</span></p>
                            ...
                            <div class="td">
                                <div class="warnNotes">
                                    ...
                                    <p>カメラマークをタップして、写真をアップロードしてください。<br>複数の写真がアップロード可能です。<br>写真はサービス詳細画面に、ポートフォリオとして表示されます。<br>必須ではございませんので、アップロードなしでも問題ございません。<br>※登録１枚目の画像がサムネイルとして表示されます。</p>
                                </div>
