					...
					<div class="mypageWrap">
						<div class="mypageSec04">
							...
							<div class="mypageItem">
								...
								<div class="mypageBox">
									<p class="specialtyBtn"><a href="{{route('resume_edit')}}"><img src="img/mypage/icon_add.svg" alt="">スキルを追加</a></p>
								</div>
							</div>
							<div class="mypageItem">
								...
								<div class="mypageBox">
									...
									<p class="specialtyBtn"><a href="{{route('resume_edit')}}"><img src="img/mypage/icon_add.svg" alt="">経歴を追加</a></p>
								</div>
							</div>
							<div class="mypageItem">
								...
								<div class="mypageBox">
									...
									<p class="specialtyBtn"><a href="{{route('resume_edit')}}"><img src="img/mypage/icon_edit.svg" alt="">職務を編集</a></p>
								</div>
							</div>
						</div>
					</div>
